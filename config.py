...
def get_config():
    ...
    config.test_file = '/data02/chengjian19/dataset/Charades/charades_sta_test.txt'  #这里存的就是对图片的描述...
    config.train_data = '/data02/chengjian19/dataset/Charades/Charades/Charades_v1_train.csv'
